...
router.register(r'passenger-travels', PassengerTravelViewSet, basename='passengertravel')
router.register(r'passenger-posts', PassengerPostViewSet, basename='passengerpost')
